/*
 * @Author: tywd
 * @Date: 2022-06-04 18:13:49
 * @LastEditors: tywd
 * @LastEditTime: 2022-06-04 18:20:14
 * @FilePath: /webpack-learn/custom-plugins/fileList-plugin.js
 * @Description: 自定义插件 
...
class FileListPlugin {
    ...
    apply(compiler) {
        ...
        // 绑定到 “thisCompilation” 钩子，初始化 compilation 时调用，在触发 compilation 事件之前调用。这个钩子 不会 被复制到子编译器。
